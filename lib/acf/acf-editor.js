...
(function ($) {
    $(document).ready(function () {
        ...
        if ($('.koto-ocr-review-panel').length) {
            setTimeout(function () {
                $('.acf-editor-main-form .acf-row:not(.acf-clone) .acf-row-handle button[aria-expanded="false"]').trigger('click');
                $('.acf-editor-main-form .acf-accordion-title[aria-expanded="false"]').trigger('click');
            }, 700);
        }
